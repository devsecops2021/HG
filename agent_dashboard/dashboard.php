               ...
               <a class=" edibtn2">
                <div class="card-body text-dark divsize" id="trasactioncount">
                    <center> <p class="lead">TRANSACTION COUNT (TODAY)</p>
                     <input type="text"class="iphid" id="trasactioncount_to" size="3"></input></center>
            ...
            <div class="">
                ...
                <div class="card-body text-dark divsize" id="pendingtrasactioncount_to1" >
                   <center>  <p class="lead">PENDING TRANSACTION COUNT (TODAY)</p>
                      ...
                      <input class="iphid" type="text" id="pendingtrasactioncount_to" size="2"></input></center>
        ...
        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12  mt-3">
            ...
            <div class="card card1">
                <div class="head">
                    ...
                    <!--<input type="search" class="float-right" placeholder="Search by MTCN" onkeyup="Find()" id="Find">-->

                </div>
                <div class="float-right ml-2">     <!--        Show Numbers Of Rows         -->
                    ...
                    <!--<input type="search" class="float-right" placeholder="Search" onkeyup="Find()" size="10"  id="Findp">-->
                    <input type="search" class="float-right mr-2"  onkeyup="Find()" id="Find">
        ...
        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12  mt-3">
            ...
            <div class="card card1">
                <div class="">
                    ...
                    <!--<input type="search" class="float-right" placeholder="Search by Sender Name" onkeyup="Find1()"  id="Find1">-->
                ...
                <div class="float-right ml-2">     <!--        Show Numbers Of Rows         -->
                   ...
                   <input type="search" class="float-right mr-2" onkeyup="Find1()"  id="Find1">
                   <label class="float-right"><b>Search by Name</b></label>
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12  mt-3">
            ...
            <div class="card card1">
                <div class="">
                    <h3>SAR List</h3>
                    <input type="search" class="float-right mr-2" onkeyup="Find2()"  id="Find2">
<label class="float-right"><b>Search by MTCN</b></label>
                </div>
                <div class="card-body text-dark">
                     <div id="" class="trx_history">
...
function trasactioncount_to(){
            ...
            $.ajax({
                url:"trasactioncount_to.php/?user_id="+user_id,
                  method:"GET",
     ...
     function trasactiontot_to(){
            // var user_id = 37;
             var user_id=document.getElementById('user_id').value;
            $.ajax({
                url:"trasactiontot_to.php/?user_id="+user_id,
                  method:"GET",
                data:{user_id,user_id},
                dataType:"json",
                success:function(data){
     ...
     function trasactiontot_ytd(){
            // var user_id = 37;
             var user_id=document.getElementById('user_id').value;
            $.ajax({
                url:"trasactiontot_ytd.php/?user_id="+user_id,
                  method:"GET",
                data:{user_id,user_id},
                dataType:"json",
                success:function(data){
     ...
     function pendingtrasactioncount_to(){
            // var user_id = 37;
             var user_id=document.getElementById('user_id').value;
            $.ajax({
                url:"pendingtrasactioncount_to.php/?user_id="+user_id,
                  method:"GET",
                data:{user_id,user_id},
                dataType:"json",
                success:function(data){
     ...
     function pendingtrasactiontot_to(){
            // var user_id = 37;
             var user_id=document.getElementById('user_id').value;
            $.ajax({
                url:"pendingtrasactiontot_to.php/?user_id"+user_id,
                  method:"GET",
                data:{user_id,user_id},
                dataType:"json",
                success:function(data){
     ...
     function pendingtrasactiontot_ytd(){
            // var user_id = 37;
             var user_id=document.getElementById('user_id').value;
            $.ajax({
                url:"pendingtrasactiontot_ytd.php/?user_id"+user_id,
                  method:"GET",
                data:{user_id,user_id},
                dataType:"json",
                success:function(data){
     ...
     pendingtrasactiontot_ytd();
      ...
      function display1(){
        //   var user_id = 37;
         var user_id=document.getElementById('user_id').value;
$.ajax({
    url: "greaterthanthousand.php/?user_id="+user_id,
      dataType: "json",
      success: function(data) {
            ...
            var len = location.length;
                ...
                if(len > 0){
                    ...
                    txt = "<tr><td>"+location[i].Sender_Name+"</td><td>"+location[i].transaction_count+"</td><td>"+location[i].Transaction_Total+"</td><td>"+location[i].Watch+"</td></tr>";
    ...
    function sarlist(){
        //   var user_id = 37;
         var user_id=document.getElementById('user_id').value;
$.ajax({
    url: "sarlist.php/?agent_id="+user_id,
      dataType: "json",
      success: function(data) {
            // var location = JSON.parse(data);
            var location = data;
    ...
    sarlist();
     ...
     function display2(){
        ...
        //   var user_id = 37;
         var user_id=document.getElementById('user_id').value;
$.ajax({
    url: "trasaction_to.php/?user_id="+user_id,
      dataType: "json",
      success: function(data) {
            // var location = JSON.parse(data);
            var location = data;
...
$.ajax({
    ...
    $("#trasaction_data td").remove(); 
        ...
        //   var user_id = 37;
         var user_id=document.getElementById('user_id').value;
$.ajax({
    url: "pending_transaction_to.php/?user_id="+user_id,
      dataType: "json",
      success: function(data) {
            // var location = JSON.parse(data);
            var location = data;
...
$.ajax({
    ...
    $("#trasaction_data td").remove(); 
        ...
        //   var user_id = 37;
         var user_id=document.getElementById('user_id').value;
$.ajax({
    url: "pending_transaction_ytd.php/?user_id="+user_id,
      dataType: "json",
      success: function(data) {
            // var location = JSON.parse(data);
            var location = data;
            ...
            var len = location.length;
                ...
                if(len > 0){
                    ...
                    txt = "<tr><td class='d-none'>"+location[i].li_id+"</td><td><a class='sender_detail' href='sender_detail.php?li_id="+location[i].li_id+"' >"+location[i].mtcn+"</a></td><td>"+location[i].date_time+"</td><td>"+location[i].amount_to_send+"</td><td class=''>"+location[i].commission_charges +"</td><td>"+location[i].discount+"</td><td>"+location[i].received_amount+"</td></tr>";
                            $("#trasaction_data").append(txt);
                    }
                }
    ...
    $("#trasaction_data td").remove(); 
        ...
        //   var user_id = 37;
         var user_id=document.getElementById('user_id').value;
$.ajax({
    url: "trasaction_ytd.php/?user_id="+user_id,
      dataType: "json",
      success: function(data) {
            // var location = JSON.parse(data);
            var location = data;
